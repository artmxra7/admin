            ...
            <div class="col-lg-8">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary"><?php echo __ADD_NEWS; ?></h6>
                </div>
                <div class="card-body">
                  <form class="user" action="" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                      <label><?php echo __NEWS_TITLE; ?></label>
                      <input type="text" class="form-control " placeholder="<?php echo __NEWS_TITLE; ?>" name="news_title" required>
                    </div>

                    <div class="form-group">
                      <label><?php echo __NEWS_URL; ?></label>
                      <input type="text" class="form-control " placeholder="<?php echo __NEWS_URL; ?>" name="news_url" required>
                    </div>

                    <div class="form-group">
                      <label><?php echo __NEWS_PHOTO_URL; ?></label>
                      <input type="text" class="form-control " placeholder="<?php echo __NEWS_PHOTO_URL; ?>" name="photo_url">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea type="text" class="form-control " placeholder="<?php echo __NEWS_CONTENT; ?>" name="news_content" rows="6"></textarea>
                    </div>
