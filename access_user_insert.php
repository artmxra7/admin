...
<?php 
    ...
    if( isset($_POST['submit']) ) {
      if(!$controller->checkUsername($_POST['username'])) {
        ...
        echo "<script >alert('".__USERNAME_ALREADY_TAKEN."');</script>";
      }
    }
?>
            ...
            <div class="col-lg-8">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary"><?php echo __ADD_ADMIN_USER; ?></h6>
                </div>
                <div class="card-body">
                  <form class="user" action="" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                      <label><?php echo __USERNAME; ?></label>
                      <input type="text" class="form-control " placeholder="<?php echo __USERNAME; ?>" name="username" required onkeypress='validateField(event)'>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control " placeholder="<?php echo __FULLNAME; ?>" name="name" required>
                    </div>
