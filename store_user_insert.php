...
<body id="page-top">
            ...
            <div class="col-lg-6">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary"><?php echo __ADD_STORE; ?></h6>
                </div>
                <div class="card-body">
                  
                    <div class="form-group">
                      <label><?php echo __STORE_NAME; ?></label>
                      <input type="text" class="form-control " placeholder="<?php echo __STORE_NAME; ?>" name="store_name" required>
                    </div>

                    <div class="form-group">
                      <label><?php echo __ADDRESS; ?></label>
                      <div class="input-group">
                        <input type="text" class="form-control " placeholder="<?php echo __ADDRESS; ?>" name="store_address" id="txtAddress">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control " placeholder="<?php echo __EMAIL; ?>" name="email">
                    </div>

                    <div class="form-group">
                      <label><?php echo __PHONE_NO; ?></label>
                      <input type="text" class="form-control " placeholder="<?php echo __PHONE_NO; ?>" name="phone_no">
                    </div>

                    <div class="form-group">
                      <label><?php echo __SMS_NO; ?></label>
                      <input type="text" class="form-control " placeholder="<?php echo __SMS_NO; ?>" name="sms_no">
                    </div>

                    <div class="form-group">
                      <label><?php echo __WEBSITE; ?></label>
                      <input type="text" class="form-control " placeholder="<?php echo __WEBSITE; ?>" name="website">
                    </div>

                    <div class="form-group">
                      <label><?php echo __IS_STORE_FEATURED; ?></label>
                      <select class="form-control" name="featured">
                        <option value="1"><?php echo __FEATURED; ?></option>
                        <option value="0" ><?php echo __NOT_FEATURED; ?></option>
                      </select>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control " placeholder="<?php echo __LATITUDE; ?>" name="lat" id="txtLat" readonly required>
                    </div>

                    <div class="form-group">
                      <label><?php echo __LONGITUDE; ?></label>
                      <input type="text" class="form-control " placeholder="<?php echo __LONGITUDE; ?>" name="lon" id="txtLon" readonly required>
                    </div>

                    <div class="form-group">
                      <label><?php echo __STORE_DESC; ?> <a href="#" data-toggle="modal" data-target="#help"><i class="fas fa-question-circle"></i></a></label>
                      <textarea type="text" class="form-control " placeholder="<?php echo __STORE_DESC; ?>" name="store_desc" rows="6"></textarea>
                    </div>

                    <button type="submit" name="submit" class="btn btn-primary "><?php echo __ADD; ?></button>
                    <a href="<?php echo $url; ?>" class="btn btn-danger "><?php echo __CANCEL; ?></a>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <div class="input-group date" id="datetimepickerStartMon" data-target-input="nearest">
                                        <input name="mon_open" type="text" class="form-control datetimepicker-input" data-target="#datetimepickerStartMon" readonly placeholder="<?php echo __OPENING; ?>" value="12:00 AM"/>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <div class="input-group date" id="datetimepickerEndMon" data-target-input="nearest">
                                        <input name="mon_close" type="text" class="form-control datetimepicker-input" data-target="#datetimepickerEndMon" readonly placeholder="<?php echo __CLOSING; ?>"  value="11:59 PM"/>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <div class="input-group date" id="datetimepickerStartTue" data-target-input="nearest">
                                        <input name="tue_open" type="text" class="form-control datetimepicker-input" data-target="#datetimepickerStartTue" readonly placeholder="<?php echo __OPENING; ?>" value="12:00 AM" />
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <div class="input-group date" id="datetimepickerEndTue" data-target-input="nearest">
                                        <input name="tue_close" type="text" class="form-control datetimepicker-input" data-target="#datetimepickerEndTue" readonly placeholder="<?php echo __CLOSING; ?>" value="11:59 PM"/>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <div class="input-group date" id="datetimepickerStartWed" data-target-input="nearest">
                                        <input name="wed_open" type="text" class="form-control datetimepicker-input" data-target="#datetimepickerStartWed" readonly placeholder="<?php echo __OPENING; ?>" value="12:00 AM" />
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <div class="input-group date" id="datetimepickerEndWed" data-target-input="nearest">
                                        <input name="wed_close" type="text" class="form-control datetimepicker-input" data-target="#datetimepickerEndWed" readonly placeholder="<?php echo __CLOSING; ?>" value="11:59 PM"/>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <div class="input-group date" id="datetimepickerStartThu" data-target-input="nearest">
                                        <input name="thu_open" type="text" class="form-control datetimepicker-input" data-target="#datetimepickerStartThu" readonly placeholder="<?php echo __OPENING; ?>" value="12:00 AM" />
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <div class="input-group date" id="datetimepickerEndThu" data-target-input="nearest">
                                        <input name="thu_close" type="text" class="form-control datetimepicker-input" data-target="#datetimepickerEndThu" readonly placeholder="<?php echo __CLOSING; ?>" value="11:59 PM"/>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <div class="input-group date" id="datetimepickerStartFri" data-target-input="nearest">
                                        <input name="fri_open" type="text" class="form-control datetimepicker-input" data-target="#datetimepickerStartFri" readonly placeholder="<?php echo __OPENING; ?>" value="12:00 AM" />
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <div class="input-group date" id="datetimepickerEndFri" data-target-input="nearest">
                                        <input name="fri_close" type="text" class="form-control datetimepicker-input" data-target="#datetimepickerEndFri" readonly placeholder="<?php echo __CLOSING; ?>" value="11:59 PM"/>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <div class="input-group date" id="datetimepickerStartSat" data-target-input="nearest">
                                        <input name="sat_open" type="text" class="form-control datetimepicker-input" data-target="#datetimepickerStartSat" readonly placeholder="<?php echo __OPENING; ?>" value="12:00 AM" />
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <div class="input-group date" id="datetimepickerEndSat" data-target-input="nearest">
                                        <input name="sat_close" type="text" class="form-control datetimepicker-input" data-target="#datetimepickerEndSat" readonly placeholder="<?php echo __CLOSING; ?>" value="11:59 PM"/>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <div class="input-group date" id="datetimepickerStartSun" data-target-input="nearest">
                                        <input name="sun_open" type="text" class="form-control datetimepicker-input" data-target="#datetimepickerStartSun" readonly placeholder="<?php echo __OPENING; ?>" value="12:00 AM" />
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <div class="input-group date" id="datetimepickerEndSun" data-target-input="nearest">
                                        <input name="sun_close" type="text" class="form-control datetimepicker-input" data-target="#datetimepickerEndSun" readonly placeholder="<?php echo __CLOSING; ?>" value="11:59 PM"/>
  ...
  <script>
        ...
        var map = new mapboxgl.Map({
            ...
            center: [<?php echo Constants::MAP_DEFAULT_LONGITUDE .','. Constants::MAP_DEFAULT_LATITUDE; ?>],
            zoom: 15
        });
      
        var marker = new mapboxgl.Marker( {draggable: true, color:<?php echo '"'.Constants::MARKER_COLOR.'"'; ?>} );
        marker.setLngLat([<?php echo Constants::MAP_DEFAULT_LONGITUDE .','. Constants::MAP_DEFAULT_LATITUDE; ?>]);
        var isAdded = false;
