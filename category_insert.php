            ...
            <div class="col-lg-8">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary"><?php echo __ADD_CATEGORY; ?></h6>
                </div>
                <div class="card-body">
                  <form class="user" action="" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                      <label><?php echo __CATEGORY_NAME; ?></label>
                      <input type="text" class="form-control " placeholder="<?php echo __CATEGORY_NAME; ?>" name="category" required>
                    </div>

                    <div class="form-group">
                      <label><?php echo __CATEGORY_ICON_URL; ?></label>
                      <input type="text" class="form-control " placeholder="<?php echo __CATEGORY_ICON_URL; ?>" name="category_icon">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control " placeholder="<?php echo __CATEGORY_MAP_ICON_URL; ?>" name="map_icon">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="category_id">
                        ...
                        <?php echo $extras->toUL($categories1, 0); ?>
                      </select>
                    </div>
