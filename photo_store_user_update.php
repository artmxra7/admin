...
<?php 
    ...
    $params = array();
    $params[0] = array( 'store_id', $photo_store->store_id );
    $backUrl = $extras->encryptParams(KEY_SALT, $params, 'photo_store_user_view.php');
            ...
            <div class="col-lg-8">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary"><?php echo __EDIT_STORE_PHOTO; ?></h6>
                </div>
                <div class="card-body">
                  <form class="user" action="" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                      <label><?php echo __PHOTO_URL; ?></label>
                      <input type="text" class="form-control " placeholder="<?php echo __PHOTO_URL; ?>" name="photo_url" value="<?php echo $photo_store->photo_url; ?>">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control " placeholder="<?php echo __THUMB_URL; ?>" name="thumb_url" value="<?php echo $photo_store->thumb_url; ?>">
                    </div>
