...
class ControllerAuthentication
{
    ...
    {
        $stmt = $this->pdo->prepare('INSERT INTO tbl_storefinder_authentication( username, password, name, role_id, is_deleted, deny_access ) 
                                        VALUES( :username, :password, :name, :role_id, 0, 0 )');
